    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="hidden lg:flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Preencha todos os dados necessários para criar o registro completo da ficha anestésica.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        <PatientFormFields
          ...
          isLoading={isLoading}
          submitButtonText={isLoading ? "Verificando e criando..." : "Começar Ficha Anestésica"}
