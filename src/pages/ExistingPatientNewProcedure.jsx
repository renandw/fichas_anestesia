...
const ExistingPatientNewProcedure = () => {
  ...
  const handleFormSubmit = async (formData) => {
    ...
    try {
      ...
      // Criar apenas o procedimento para o paciente existente
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="lg:hidden px-5 m-5">
        <p className="text-sm text-gray-600">
          Criar novo procedimento para {existingPatient.name}.
        </p>
      </div>
      ...
      <div className="hidden lg:flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Criar novo procedimento para <span className="font-medium">{existingPatient.name}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        <PatientFormFields
          ...
          isLoading={isLoading}
          submitButtonText={isLoading ? "Criando procedimento..." : "Criar Procedimento"}
...
export default ExistingPatientNewProcedure;