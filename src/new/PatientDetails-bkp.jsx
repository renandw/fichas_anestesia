...
const PatientDetails = () => {
  ...
  const fetchPatientData = useCallback(async () => {
    try {
      ...
      const surgeriesData = await getPatientSurgeries(patientId);
            ...
            {isEditingPatient ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-2 p-2">
                  <h2 className="text-xl font-semibold text-gray-900">Editando Paciente</h2>
                  <button
        ...
        {isCreatingNewSurgery && (
          <div className="mb-6 border border-blue-200 rounded-lg p-4 bg-blue-50">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <h4 className="font-medium text-blue-900">Nova Cirurgia</h4>
              </div>
            </div>
          ...
          <div className="space-y-2">
            {paginatedSurgeries.map((surgery, sIndex) => {
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-3">
                          ...
                          <h4 className="font-medium text-blue-900">Editando Cirurgia {surgery.code}</h4>
                        </div>
                        <button
              ...
              return (
                <div
                  key={surgery.id || `surgery-${sIndex}`}
                  className="rounded-lg border pb-4 hover:bg-gray-50 transition-colors"
                >
                  ...
                  <div className="flex flex-wrap gap-2 justify-between mt-2">
                    <div className="flex gap-2">
                      {(() => {
                        const actions = getButtonActions(surgery);
                        return (
                          <>
                            {/* Botão Pré-anestésica */}
                            <button
                              onClick={() => handleButtonAction(surgery, actions.preAnesthesia.action)}
                            ...
                            {/* Botão Anestesia */}
                            <button
                              onClick={() => handleButtonAction(surgery, actions.anesthesia.action)}
                            ...
                            {/* Botão SRPA */}
                            <button
                              onClick={() => handleButtonAction(surgery, actions.srpa.action)}
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1 text-xs border border-gray-300 rounded hover:bg-gray-50 text-gray-700"
                    >
                    ...
                    <div className="relative">
                      <button
                        onClick={() => setDeletingConfirmation(deletingConfirmation === surgery.id ? null : surgery.id)}
                        className="p-1 hover:bg-gray-100 rounded"
                        title="Mais ações"
                      >
                        <MoreVertical className="w-4 h-4 text-gray-500" />
                      </button>
                      {deletingConfirmation === surgery.id && (
